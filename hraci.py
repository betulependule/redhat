...
def hraci(kolo):
	...
	while kolo<=5:
		...
		if a>b and a>c and a>d:
			...
			print("Hraci 1 a 2 jsou vitezi kola {} se skorem {}.".format(kolo, a))
			hrac1=hrac1+1
			hrac2=hrac2+1
		elif a==c and a>b and a>d:
			print("Hraci 1 a 3 jsou vitezi kola {} se skorem {}.".format(kolo, a))
			hrac1=hrac1+1
			hrac3=hrac3+1
		elif a==d and a>c and a>b:
			print("Hraci 1 a 4 jsou vitezi kola {} se skorem {}.".format(kolo, a))
			hrac1=hrac1+1
			hrac4=hrac4+1
		elif b==c and b>a and b>d:
			print("Hraci 2 a 3 jsou vitezi kola {} se skorem {}.".format(kolo, b))
			hrac3=hrac3+1
			hrac2=hrac2+1
		elif b==d and b>c and b>a:
			print("Hraci 2 a 4 jsou vitezi kola {} se skorem {}.".format(kolo, b))
			hrac4=hrac4+1
			hrac2=hrac2+1
		elif c==d and c>b and c>a:
			print("Hraci 3 a 4 jsou vitezi kola {} se skorem {}.".format(kolo, c))
			hrac3=hrac3+1
			hrac2=hrac2+1
		elif a==b==c and a>d:
			print("Hraci 1, 2 a 3 jsou vitezi kola {} se skorem {}.".format(kolo, a))
			hrac1=hrac1+1
			hrac2=hrac2+1
			hrac3=hrac3+1
		elif a==b==d and a>c:
			print("Hraci 1, 2 a 4 jsou vitezi kola {} se skorem {}.".format(kolo, a))
			hrac1=hrac1+1
			hrac2=hrac2+1
			hrac4=hrac4+1
		elif b==c==d and b>a:
			print("Hraci 2, 3 a 4 jsou vitezi kola {} se skorem {}.".format(kolo, b))
			hrac4=hrac4+1
			hrac2=hrac2+1
			hrac3=hrac3+1
		elif a==c==d and a>b:
			print("Hraci 1, 3 a 4 jsou vitezi kola {} se skorem {}.".format(kolo, a))
			hrac1=hrac1+1
			hrac4=hrac4+1
			hrac3=hrac3+1 
		kolo=kolo+1
